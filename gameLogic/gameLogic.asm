...
# R0
# R1 - Store the first bit needed to be checked in each case
# R2 - Store the second bit needed to be checked in each case
# R3 - Store the Third bit needed to be checked in each case
# R4 - Player 1's board
# R5 - Player 2's board
# R6 - Player #: 0-PlayerX ; 1-PlayerO
################################################################################
MOV R0 CHECKWIN
J R0
...
_ROW1_Player1
MOV0 R0, 00000001
MOV0 R0, 00000000              # Mask for Grid 1: 000000001
AND R1, R4, R0
AND R1
_ROW2
